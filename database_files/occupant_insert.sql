...
CREATE OR REPLACE FUNCTION public.occupant_insert(
...
BEGIN  app_date := CURRENT_TIMESTAMP;
	IF in_query_type='insert' THEN 	
        ...
        occupant_id, floor_area_m2, name_of_occupant, type_of_occupant, use_type_of_unit, occupier_is_owner, owner_details, tel_mobile, tel_home, parcels_id, structure_id, "createdAt", "updatedAt")
