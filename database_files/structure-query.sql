-- PROCEDURE: public.structure_queries(character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, integer, character varying, integer, character varying, character varying)

-- DROP PROCEDURE public.structure_queries(character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, integer, character varying, integer, character varying, character varying);

CREATE OR REPLACE PROCEDURE public.structure_queries(
...
BEGIN  app_date := CURRENT_TIMESTAMP;
	IF in_query_type='insert' THEN 	
        ...
        IF FOUND THEN            
            ...
            RAISE NOTICE 'Structures created sucessfully with LAST id: %', app_id;
        END IF;
